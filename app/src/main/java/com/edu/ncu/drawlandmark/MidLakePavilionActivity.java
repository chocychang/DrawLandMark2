...
public class MidLakePavilionActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mid_lake_pavilion);
    ...
    private void initViews() {
        ...
        mp =MediaPlayer.create(this, R.raw.midlakepavilion);
        ...
        bt_guess2.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v)
            {
                ...
                Intent intent = new Intent(MidLakePavilionActivity.this, QueMenuActivity.class);
        ...
        bt_drawingFun_inK.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v)
            {
                ...
                Intent intent = new Intent(MidLakePavilionActivity.this, ChooseDraw.class);
                Bundle bundle = new Bundle();
                //儲存資料　第一個為參數key，第二個為Value
        ...
        bt_profolio.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v)
            {
                new AlertDialog.Builder(MidLakePavilionActivity.this)
                        .setTitle("近請期待")
    ...
    public void getListenCoin(){
        mp.setOnCompletionListener(new MediaPlayer.OnCompletionListener(){
            ...
            public void onCompletion(MediaPlayer mp) {
                mp.release();
                Intent intent = new Intent(MidLakePavilionActivity.this, GainXPCoinDialog.class);
    ...
    private void initAdapter() {
        ...
        vp.setAdapter(new MidLakePavilionActivity.MyPagerAdapter());

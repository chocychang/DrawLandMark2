...
public class AnpingFortActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anping_fort);
    ...
    private void initViews() {
        ...
        mp = MediaPlayer.create(this, R.raw.anpingfort);
        ...
        bt_guess2.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v)
            {
                ...
                Intent intent = new Intent(AnpingFortActivity.this, QueMenuActivity.class);
        ...
        bt_drawingFun_inK.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v)
            {
                ...
                Intent intent = new Intent(AnpingFortActivity.this, ChooseDraw.class);
                Bundle bundle = new Bundle();
                //儲存資料　第一個為參數key，第二個為Value
        ...
        bt_profolio.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v)
            {
                new AlertDialog.Builder(AnpingFortActivity.this)
                        .setTitle("近請期待")
    ...
    public void getListenCoin(){
        mp.setOnCompletionListener(new MediaPlayer.OnCompletionListener(){
            ...
            public void onCompletion(MediaPlayer mp) {
                mp.release();
                Intent intent = new Intent(AnpingFortActivity.this, GainXPCoinDialog.class);
    ...
    private void initAdapter() {
        ...
        vp.setAdapter(new AnpingFortActivity.MyPagerAdapter());
